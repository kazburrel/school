    ...
    function y(e) {
        ...
        if (!o)
            e: {
                if (
                    ((o = -1 !==
                            navigator.userAgent.toLowerCase().indexOf("firefox")), -1 === navigator.userAgent.indexOf("Trident") ||
                        !i(e) ||
                        "fixed" !== c(e).position)
                )
                    for (
...
!(function(t, e) {
    ...
    class Z extends B {
        ...
        _slide(t, e) {
            ...
            else if (!this._triggerSlideEvent(o, g).defaultPrevented &&
                i &&
                o
            ) {
                if (
    ...
    class dt extends B {
        ...
        show() {
            ...
            if (!R.trigger(this._element, "show.bs.dropdown", e)
                .defaultPrevented
            ) {
                if (this._inNavbar)
    ...
    class Rt extends B {
        ...
        hide() {
            ...
            if (!R.trigger(this._element, this.constructor.Event.HIDE)
                .defaultPrevented
            ) {
                if (
...
!(function(e) {
    ...
    function o(t) {
        e.requestAnimationFrame(function() {
            ...
            for (var e = 0, i = h.length; e < i; e++)
                "scroll" !== t.type &&
                (h[e].coverImage(), h[e].clipContainer()),
                h[e].onScroll();
        });
    }
    Date.now ||
        ...
        !(function() {
            for (
                var t = ["webkit", "moz"], n = 0; n < t.length && !e.requestAnimationFrame;
                ++n
            ) {
                var i = t[n];
            ...
            function e(e, n) {
                ...
                if (
                    ((o.$item = e),
                        ...
                        (i = JSON.parse(
                            o.$item.getAttribute("data-jarallax") || "{}"
                        )),
                        (o.options = o.extend({}, o.defaults, i, n)), !(!s ||
                            (p && o.options.noAndroid) ||
                            (u && o.options.noIos)
                        ))
                ) {
                    ...
                    a &&
                        ...
                        (a = a[0]), !a instanceof Element && (a = null),
    ...
    (y.prototype.init = function() {
        ...
        for (
            var o = 0, a = t.$item; null !== a && a !== document && 0 === o;
        ...
        for (a; a < o; a++)
            if (
                ("object" == typeof n || "undefined" == typeof n ?
                    ...
                    e[a].jarallax &&
                    (t = e[a].jarallax[n].apply(e[a].jarallax, i)),
                    "undefined" != typeof t)
            )
                return t;
        return e;
...
!(function(e) {
    ...
    (a.prototype.getImageURL = function(e) {
        ...
        if ("vimeo" === t.type) {
            ...
            n.open(
                    "GET",
                    "https://vimeo.com/api/v2/video/" + t.videoID + ".json", !0
                ),
        ...
        return i.$iframe ?
            ...
            void i.onAPIready(function() {
                ...
                if (
                    ...
                    s &&
                        ((i.$iframe = document.getElementById(
                                i.playerID
                            )),
                            (i.videoWidth =
                                parseInt(
                                    i.$iframe.getAttribute("width"),
                                    10
                                ) || 1280),
                            (i.videoHeight =
                                parseInt(
                                    i.$iframe.getAttribute("height"),
                                    10
                                ) || 720));
                }
                if ("vimeo" === i.type) {
                    ...
                    i.options.controls ||
                        ...
                        ((i.$iframe =
                            ...
                            document.body.appendChild(n)),
                        (i.player =
                            i.player || new Vimeo.Player(i.$iframe)),
    ...
    if ("undefined" != typeof jarallax) {
        ...
        e.prototype.coverImage = function() {
            ...
            i.apply(e),
                ...
                e.css(e.image.$item, {
                    height: e.image.$item.getBoundingClientRect().height +
                        400 +
                        "px",
                    marginTop:
                        -200 +
                        parseFloat(e.css(e.image.$item, "margin-top")) +
                        "px",
                });
        };
...
!(function(e) {
    (e.fn.ihavecookies = function(n, c) {
        ...
        if (s && p && "reinit" != c) {
            ...
            var u =
                '<div id="gdpr-cookie-message" class="d-block d-lg-flex align-items-center justify-content-lg-between justify-content-start"><div><h4>' +
                a.title +
                "</h4><p>" +
                a.message +
                ' <a href="' +
            ...
            setTimeout(function() {
                            ...
                            "reinit" == c &&
                                (e("#gdpr-cookie-advanced").trigger("click"),
                                    e.each(preferences, function(o, i) {
                                        e("input#gdpr-cookietype-" + i).prop(
                                            "checked", !0
                                        );
                                    }));
                        });
                ...
                e("body").on("click", "#gdpr-cookie-accept", function() {
                    o(!0, a.expires),
                        e('input[name="gdpr[]"][data-auto="on"]').prop(
                            "checked", !0
                        );
                    var t = [];
                    e.each(
                            e('input[name="gdpr[]"]').serializeArray(),
                            function(e, o) {
                                t.push(o.value);
                            }
                        ),
    ...
    (e.fn.ihavecookies.preference = function(e) {
        ...
        return (
            (i = JSON.parse(i)), !1 !== o && !1 !== i && -1 !== i.indexOf(e)
        );
    });
    var o = function(o, t) {
            i("cookieControl", o, t),
