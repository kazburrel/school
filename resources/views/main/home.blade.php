                        ...
                        <div class="px-15 pt-15">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="box">
                                        <a href="#">
                                            <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/4.jpg')}}" alt="Card image cap">
                                        </a>
                                        <div class="box-body"> 
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="box">
                                        <a href="#">
                                            <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/6.jpg')}}" alt="Card image cap">
                                        </a>
                                        <div class="box-body"> 
                                            <div class="text-start">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="box">
                                        <a href="#">
                                            <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/5.jpg')}}" alt="Card image cap">
                                        </a>
                                        <div class="box-body"> 
                                            <div class="text-start">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="box">
                                        <a href="#">
                                            <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/2.jpg')}}" alt="Card image cap">
                                        </a>
                                        <div class="box-body"> 
                                            <div class="text-start">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="box">
                                        <a href="#">
                                            <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/7.jpg')}}" alt="Card image cap">
                                        </a>
                                        <div class="box-body"> 
                                            <div class="text-start">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="box">
                                        <a href="#">
                                            <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/9.jpg')}}" alt="Card image cap">
                                        </a>
                                        <div class="box-body"> 
                                            <div class="text-start">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="box">
                                        <a href="#">
                                            <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/10.jpg')}}" alt="Card image cap">
                                        </a>
                                        <div class="box-body"> 
                                            <div class="text-start">
                        ...
                        <div class="col-lg-6 col-12 position-relative">
                            <div class="media-list media-list-hover media-list-divided md-post mt-lg-0 mt-30">
                                <a class="media media-single box-shadowed bg-white pull-up mb-15" href="#">
                                  <img class="w-80 rounded ms-0" src="{{asset('main_assets/images/front-end-img/avatar/1.jpg')}}" alt="...">
                                ...
                                <a class="media media-single box-shadowed bg-white pull-up mb-15" href="#">
                                  <img class="w-80 rounded ms-0" src="{{asset('main_assets/images/front-end-img/avatar/2.jpg')}}" alt="...">
                                  <div class="media-body fw-500">
                                    <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                    <small class="text-fade">Today, 5:00 PM</small>
                                    <p><small class="text-fade mt-10">Johen doe</small></p>
                                ...
                                <a class="media media-single box-shadowed bg-white pull-up mb-15" href="#">
                                  <img class="w-80 rounded ms-0" src="{{asset('main_assets/images/front-end-img/avatar/3.jpg')}}" alt="...">
                                  <div class="media-body fw-500">
                                    <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                    <small class="text-fade">Today, 5:00 PM</small>
                                    <p><small class="text-fade mt-10">Johen doe</small></p>
                                ...
                                <a class="media media-single box-shadowed bg-white pull-up mb-0" href="#">
                                  <img class="w-80 rounded ms-0" src="{{asset('main_assets/images/front-end-img/avatar/4.jpg')}}" alt="...">
                                  <div class="media-body fw-500">
                                    <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                    <small class="text-fade">Today, 5:00 PM</small>
                                    <p><small class="text-fade mt-10">Johen doe</small></p>
        ...
        <div class="row mt-30">
            <div class="col-12">
                <div class="owl-carousel owl-theme owl-btn-1" data-nav-arrow="false" data-nav-dots="false" data-items="6" data-md-items="4" data-sm-items="3" data-xs-items="2" data-xx-items="2">
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-1.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-2.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-3.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-4.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-5.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-6.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-7.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-8.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-9.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-10.jpg"')}} class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-11.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{asset('main_assets/images/front-end-img/unilogo/uni-12.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="px-15 pt-15">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="card">
                                        <a href="#">
                                            <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/1.jpg')}}" alt="Card image cap">
                                        </a>
                    ...
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('main_assets/images/front-end-img/avatar/1.jpg')}}" class="avatar avatar-lg rounded10" alt="">
                                </div>
                ...
                <div class="box pull-up">
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('main_assets/images/front-end-img/avatar/2.jpg')}}" class="avatar avatar-lg rounded10" alt="">
                                </div>
                                <div class="d-flex flex-column fw-500">
                ...
                <div class="box pull-up">
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('main_assets/images/front-end-img/avatar/3.jpg')}}" class="avatar avatar-lg rounded10" alt="">
                                </div>
                                <div class="d-flex flex-column fw-500">
                ...
                <div class="box pull-up">
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('main_assets/images/front-end-img/avatar/4.jpg')}}" class="avatar avatar-lg rounded10" alt="">
                                </div>
                                <div class="d-flex flex-column fw-500">
                ...
                <div class="box pull-up">
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('main_assets/images/front-end-img/avatar/5.jpg')}}" class="avatar avatar-lg rounded10" alt="">
                                </div>
                                <div class="d-flex flex-column fw-500">
                ...
                <div class="box pull-up">
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('main_assets/images/front-end-img/avatar/6.jpg')}}" class="avatar avatar-lg rounded10" alt="">
                                </div>
                                <div class="d-flex flex-column fw-500">
                                    <a href="#" class="text-dark hover-primary mb-1 fs-16">Johen Doe</a>
                ...
                <div class="box pull-up">
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('main_assets/images/front-end-img/avatar/7.jpg')}}" class="avatar avatar-lg rounded10" alt="">
                                </div>
                                <div class="d-flex flex-column fw-500">
                ...
                <div class="box pull-up">
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                <div class="me-15">
                                    <img src="{{asset('main_assets/images/front-end-img/avatar/8.jpg')}}" class="avatar avatar-lg rounded10" alt="">
                                </div>
                                <div class="d-flex flex-column fw-500">
    ...
    <div class="container">
        ...
        <div class="row mt-30">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card">
                    <a href="#">
                        <img class="card-img-top" src="{{asset('main_assets/images/front-end-img/courses/3.jpg')}}" alt="Card image cap">
                    </a>
                    <div class="position-absolute r-10 t-10"> 
                        <button type="button" class="waves-effect waves-circle btn btn-circle btn-dark btn-xs me-5"><i class="fa fa-heart-o"></i></button>
                        <button type="button" class="waves-effect waves-circle btn btn-circle btn-dark btn-xs me-5"><i class="fa fa-share-alt"></i></button>
            ...
            <div class="col-xl-4 col-md-4 col-12">
                <div class="blog-post">
                    <div class="entry-image clearfix">
                        <img class="img-fluid" src="{{asset('main_assets/images/front-end-img/courses/1f.jpg')}}" alt="">
                    </div>
                ...
                <div class="blog-post">
                    <div class="entry-image clearfix">
                        <div class="owl-carousel bottom-dots-center owl-theme" data-nav-dots="true" data-autoplay="true"  data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
                            <div class="item">
                                <img src="{{asset('main_assets/images/front-end-img/courses/2f.jpg')}}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('main_assets/images/front-end-img/courses/3f.jpg')}}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('main_assets/images/front-end-img/courses/4f.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="blog-detail">
                ...
                <div class="blog-post">
                    <div class="entry-image clearfix">
                        <ul class="grid-post list-unstyled">
                            <li>
                                <img class="img-fluid" src="{{asset('main_assets/images/front-end-img/courses/5f.jpg')}}" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{asset('main_assets/images/front-end-img/courses/6f.jpg')}}" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{asset('main_assets/images/front-end-img/courses/7f.jpg')}}" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{asset('main_assets/images/front-end-img/courses/8f.jpg')}}" alt="">
                            </li>
                        </ul>
                    </div>
                    <div class="blog-detail">
