                ...
                <div class="col-lg-6 col-12">
                    <div class="box box-body">
                        <ul class="nav nav-tabs nav-fill" role="tablist">
                            <li class="nav-item"> <a class="nav-link active py-10 rounded" data-bs-toggle="tab"
                                    href="#login" role="tab">Login</a> </li>
                            <li class="nav-item"> <a class="nav-link py-10 rounded" data-bs-toggle="tab" href="#register"
                                        ...
                                        <form action="index.html" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 text-center">
                                                    <button type="submit" class="btn btn-info w-p100 mt-15">SIGN
                                                        IN</button>
                                                </div>
                                                <!-- /.col -->
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="checkbox ms-5">
                                                        ...
                                                        <label for="basic_checkbox_22" class="form-label">I agree to the
                                                            <a href="#"
                                                ...
                                                <div class="col-12 text-center">
                                                    <button type="submit"
                                                        class="btn btn-info w-p100 mt-15">Register</button>
                                                </div>
                                                <!-- /.col -->
                                            </div>
                                        </form>
