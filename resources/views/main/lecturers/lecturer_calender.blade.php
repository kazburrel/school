...
@section('content')
    @include('main.lecturers.lecturer_components.calender')
    @if ($errors->any())
                ...
                <div class="modal fade" id="kt_modal_add_event" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('addingOfEvent') }}" method="POST"
                                ...
                                <div class="modal-body py-10 px-lg-17">
                                    ...
                                    @error('calendar_event_description')
                                        <p class="text-danger">
                                            {{ $message }}
                                        </p>
                                    @enderror
                                    ...
                                    <div class="fv-row mb-9">
                                        ...
                                        <label class="form-check form-check-custom form-check-solid">
                                            {{-- <input type="checkbox" name="all_day" id="kt_calendar_datepicker_allday" hidden value="0"> --}}
                                            <input class="form-check-input" type="checkbox" name="all_day"
                                    ...
                                    <div class="row row-cols-lg-2 g-10">
                                        ...
                                        @error('calendar_event_start_time')
                                            <p class="text-danger">
                                                {{ $message }}
                                            </p>
                                        @enderror
                                ...
                                <div class="modal-footer flex-center">
                                    ...
                                    <!--end::Button-->
                                    <!--begin::Button-->
                                    <button type="submit" class="btn btn-primary" id="kt_modal_add_event_submit">
                                        <span>Submit</span>
