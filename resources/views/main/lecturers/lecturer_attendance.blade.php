                        ...
                        <div class="col-md-2 fv-row">
                            ...
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <input class="form-control form-control-solid ps-12" placeholder="Select a date"
                                    name="date" type="date" value="{{ old('join_date') }}" />
                                @error('date')
                                    <p class="text-danger">
                                        {{ $message }}
                                    </p>
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 text-center">
                        ...
                        <tbody>
                            ...
                            @forelse ($regStudents as $registeredStudent)
                                <input hidden type="text" name="course" value="{{ $course }}">
                                {{-- <input hidden type="text" name="lecturer" value="{{ Auth()->user()->lecturer_id }}"> --}}
                                <tr>
                                    <div class="">
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="text-dark fw-bolder  d-block fs-6">{{ $registeredStudent->student->fname }}
                                                &nbsp;
                                                {{ $registeredStudent->student->lname }}</span>
                                            <input hidden type="text" name="student[]"
                                                value="{{ $registeredStudent->student->reg_no }}">
                                        </td>
                                    </div>
