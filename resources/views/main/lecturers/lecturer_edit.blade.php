...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <!--begin::Navbar-->
            @include('main.lecturers.lecturer_layouts.nav')
            <!--end::Navbar-->
            <!--begin::Basic info-->
                        ...
                        <div class="card-body border-top p-9">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true"
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px"
                                            style="background-image: url({{ asset('storage/' . $lecturer->pro_pic) }})">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 fv-row">
                                            <input type="text" name="fname"
                                                ...
                                                placeholder="First name" value="{{ $lecturer->fname }}" disabled />
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-lg-6 fv-row">
                                            <input type="text" name="lname"
                                                ...
                                                placeholder="Last name" value="{{ $lecturer->lname }}" disabled />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Row-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="company"
                                        ...
                                        value="{{ $lecturer->departmentDetails->dept_name }}" disabled />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="tel" name="phone"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="Phone number" value="{{ $lecturer->mobile_no }}" disabled />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="website"
                                        ...
                                        value="{{ $lecturer->address }}" disabled />
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="website"
                                        class="form-control form-control-lg form-control-solid" placeholder="Address"
                                        value="{{ $lecturer->reg_no }}" disabled />
                                </div>
                                <!--end::Col-->
                            </div>
                            <div class="row mb-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="website"
                                        class="form-control form-control-lg form-control-solid" placeholder="Address"
                                        value="{{ $lecturer->status == 1 ? 'Active' : 'Blocked' }}" disabled />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div id="kt_signin_email">
                                ...
                                <div class="fw-bold text-gray-600">{{ $lecturer->email }}</div>
                            </div>
                            <!--end::Label-->
                            <!--begin::Edit-->
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-10">
                            ...
                            <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                ...
                                <form class="form" novalidate="novalidate" method="POST"
                                    action="{{ route('UpdatelecturerPassword') }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-1">
                                        <div class="col-lg-4">
