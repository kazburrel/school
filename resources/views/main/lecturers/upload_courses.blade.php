...
<div class="modal-dialog modal-dialog-centered w-100">
    ...
    <div class="modal-content rounded">
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_new_target_form" class="form" action="/admin/add_course" method="POST"
                enctype="multipart/form-data">
                @csrf
                <!--begin::Heading-->
                <div class="mb-13 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3">Add a New Course</h1>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Input group-->
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <select class="form-select" aria-label="Select example" name="department">
                        ...
                        {{-- @forelse ($departments as $department) --}}
                            ...
                            <option value="{{ $departments->dept_id }}" {{ $departments->dept_name === $lecturers->department ? 'selected' : '' }}>
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <input type="text" class="form-control form-control-solid" placeholder="Enter course Code"
                ...
                <div class="col-md-12 fv-row">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Icon-->
                        <!--begin::Datepicker-->
                        <input class="form-control form-control-solid ps-12" placeholder="Select date" name="start_date"
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <input type="text" class="form-control form-control-solid" placeholder="Enter Course Duration"
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <input type="text" class="form-control form-control-solid" placeholder="Enter Course Price"
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <select class="form-select" aria-label="Select example" name="lecturer">
                        <option value="">Select Lecturer</option>
                            <option value="{{ $lecturers->lecturer_id }}"  {{ $lecturers->lecturer_id === $lecturers->lecturer_id ? 'selected' : '' }}>
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <input type="number" class="form-control form-control-solid" placeholder="Maximum Students"
                        name="max_student" value="{{ old('max_student') }}" />
                    @error('max_student')
                        <p class="text-danger">
                            {{ $message }}
                        </p>
