...
<div class="modal-dialog modal-dialog-centered w-100">
    ...
    <div class="modal-content rounded">
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_new_target_form" class="form" action="/admin/add_libraryAsset" method="POST"
                enctype="multipart/form-data">
                @csrf
                <!--begin::Heading-->
                <div class="mb-13 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3">Add Library Assets</h1>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Input group-->
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <input type="text" class="form-control form-control-solid"
                        placeholder="Enter Authur's Name" name="authur" value="{{ old('authur') }}" />
                    @error('authur')
                        <p class="text-danger">
                            {{ $message }}
                        </p>
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <input type="text" class="form-control form-control-solid" placeholder="Enter Publisher's Name"
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <select class="form-select" aria-label="Select example" name="assetType">
                        <option value="">Select Asset Type</option>
                        <option value="book" {{ old('assetType',) == 'book' ? 'selected' : '' }}>Book</option>
                        <option value="cd" {{ old('assetType',) == 'cd' ? 'selected' : '' }}>CD</option>
                        <option value="dvd" {{ old('assetType',) == 'dvd' ? 'selected' : '' }}>DVD</option>
                        <option value="newspaper" {{ old('assetType',) == 'newspaper' ? 'selected' : '' }}>NewsPaper</option>
                    ...
                    <div class="col-md-12 fv-row">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            ...
                            <input class="form-control form-control-solid ps-12" placeholder="Select a date"
                                name="purchase_date" type="date" value="{{ old('purchase_date') }}" />
                            @error('purchase_date')
                                <p class="text-danger">
                                    {{ $message }}
                                </p>
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <input type="number" class="form-control form-control-solid" placeholder="Enter Quantity"
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <select class="form-select" aria-label="Select example" name="mode">
                        <option value="">Select Mode</option>
                        <option value="borrow" {{ old('mode',) == 'borrow' ? 'selected' : '' }}>Borrow</option>
                        <option value="forsale" {{ old('mode',) == 'forsale' ? 'selected' : '' }}>For Sale</option>
                        {{-- <option value="issue" {{ old('status',) == 'issue' ? 'selected' : '' }}>Issue</option>
                        <option value="repair" {{ old('status',) == 'repair' ? 'selected' : '' }}>Repair</option> --}}
                    </select>
                    @error('mode')
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <!--end::Label-->
                   <textarea class="form-control form-control-solid" name="details" id=""  rows="3" placeholder="Asset details">
                        {{old('details')}}
                   </textarea>
                    @error('details')
                        <p class="text-danger">
