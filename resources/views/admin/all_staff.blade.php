            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 text-center">
                ...
                <thead>
                    <tr class="fw-bolder text-muted">
                        <th class="min-w-50px">Staff Id</th>
                                        ...
                                        <form id="kt_modal_new_target_form" class="form"
                                            ...
                                            <div class="d-flex flex-column mb-8 fv-row">
                                                ...
                                                <select class="form-select" aria-label="Select example"
                                                    ...
                                                    <option @selected($staff->department == 'library') value="library">Library</option>
                                                    <option @selected($staff->department == 'administration') value="administration">Administration</option>
                                                    <option @selected($staff->department == 'transport') value="transport">Transport</option>
                                                    <option @selected($staff->department == 'laboratory') value="laboratory">Laboratory</option>
