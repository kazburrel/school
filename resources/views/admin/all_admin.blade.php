    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">All admin</span>
                <span class="text-muted mt-1 fw-bold fs-7"></span>
            </h3>
            {{-- SEARCH BEGINS --}}

            <!--begin::Input group-->
            <form action="/admin/all_admin" class="d-flex align-items-center">
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                ...
                <a href="/admin/add_admin" class="btn btn-sm btn-light btn-active-primary">
                    ...
                    <tbody>
                        @forelse ($admins as $i => $admin)
                            <tr>
                                ...
                                <td>
                                    <span class="text-dark fw-bolder  d-block fs-6">{{ $admin->admin_unique_id }}</span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-45px me-5">
                                            <img src="{{ asset('storage/' . $admin->admin_avatar) }}" alt="" />
                                        </div>
                                        <div class=justify-content-start flex-center">
                                            <span class="text-dark fw-bolder  d-block fs-6">{{ $admin->fname }} </span>
                                            <span class="text-dark fw-bolder  d-block fs-6">{{ $admin->lname }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <div class="d-flex flex-center w-100 me-2">
                                        <span class="text-dark fw-bolder  d-block fs-6">{{ $admin->join_date }}</span>
                                    </div>
                                </td>
                              
                                <td class="text-end">
                                    <div class="d-flex flex-center w-100 me-2">
                                        <span class="text-dark fw-bolder  d-block fs-6">{{ ucwords($admin->gender) }}</span>
                                    </div>
                                </td>
                                <td class="text-end">
                                    <div class="d-flex flex-center w-100 me-2">
                                        <span class="text-dark fw-bolder  d-block fs-6">{{ $admin->mobile_no }}</span>
                                    </div>
                                </td>
                                <td class="text-end">
                                    <div class="d-flex flex-center w-100 me-2">
                                        <span
                                            class=" fw-bolder  d-block fs-7 p-1 px-2 {{ $admin->status == true ? 'btn btn-light-success' : 'btn btn-light-danger' }}">{{ $admin->status == true ? 'Active' : 'Blocked' }}</span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <div class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_add_user-{{ $admin->id }}">
                                        ...
                                        <div class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            ...
                                            data-bs-target="#kt_modal_block_user{{ $admin->id }}">
                                            <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                            ...
                            <div class="modal fade" tabindex="-1" id="kt_modal_block_user{{ $admin->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content text-center">
                                        ...
                                        <div class="modal-body">
                                            <p>Are you sure you want to {{ $admin->status == true ? 'block' : 'unblock' }}
                                                admin?</p>
                                        </div>
                                        ...
                                        <div class="modal-footer d-flex justify-content-center">
                                            ...
                                            <x-block href="/admin/all_admin/{{ $admin->admin_unique_id }}"
                                                :status="$admin->status" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" tabindex="-1" id="kt_modal_1{{ $admin->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content text-center">
                                        <div class="modal-header">
                                            <h5 class="modal-title"></h5>
                                        ...
                                        <div class="modal-footer d-flex justify-content-center">
                                            <button type="button" class="btn btn-light"
                                                data-bs-dismiss="modal">Close</button>
                                            <x-delete href="/admin/all_admin/{{ $admin->admin_unique_id }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" id="kt_modal_add_user-{{ $admin->id }}" tabindex="-1"
                                aria-hidden="true">
                                <!--begin::Modal dialog-->
                                    ...
                                    <div class="modal-content rounded">
                                        ...
                                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                            ...
                                            <form id="kt_modal_new_target_form" class="form"
                                                action="/admin/all_admin/{{ $admin->admin_unique_id }}" method="POST"
                                                ...
                                                <div class="mb-13 text-center">
                                                    <!--begin::Title-->
                                                    <h1 class="mb-3">Update {{ $admin->fname }}
                                                        {{ $admin->lname }} Details</h1>
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Input group-->
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <input class="form-control form-control-solid ps-12"
                                                                ...
                                                                type="date"
                                                                value="{{ old('join_date') ?? $admin->join_date }}" />
                                                            @error('join_date')
                                                                <p class="text-danger">
                                                                    {{ $message }}
                                                                </p>
                                                ...
                                                <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <input type="file" class="form-control form-control-solid"
                                                        placeholder="" name="admin_avatar"
                                                        value="{{ old('admin_avatar') ?? $admin->admin_avatar }}" />
                                                    @error('admin_avatar')
                                                        <p class="text-danger">
                                                            {{ $message }}
                                                        </p>
