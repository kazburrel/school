                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 text-center">
                    ...
                    <tbody>
                        @forelse ($lecturers as $lecturer)
                            <tr>
                                <td>
                                    <span class="text-dark fw-bolder  d-block fs-6">{{ $lecturer->id }}</span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-center">
                                ...
                                <td class="text-end">
                                    <div class="d-flex flex-center w-100 me-2">
                                        <span class="text-dark fw-bolder  d-block fs-6">{{ Str::words($lecturer->address, 5) }}</span>
                                    </div>
                                </td>
                                <td class="text-end">
                                        ...
                                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                            ...
                                            <form id="kt_modal_new_target_form" class="form"
                                                ...
                                                <div class="mb-13 text-center">
                                                    <!--begin::Title-->
                                                    <h1 class="mb-3">Update {{$lecturer->fname}} {{$lecturer->lname}} Details</h1>
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Input group-->
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <input class="form-control form-control-solid ps-12"
                                                                ...
                                                                type="date" value="{{ old('join_date') ?? $lecturer->join_date  }}" />
                                                            @error('join_date')
                                                                <p class="text-danger">
                                                                    {{ $message }}
                                                                </p>
                                                ...
                                                {{-- <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <input type="password" class="form-control form-control-solid"
                                                        placeholder="Enter Department Name" name="password"
                                                        value="{{ old('password') ?? $lecturer->password  }}" />
                                                    @error('password')
                                                        <p class="text-danger">
                                                            {{ $message }}
                                                        </p>
                                                ...
                                                <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <select class="form-select" aria-label="Select example"
                                                        ...
                                                        <option @selected($lecturer->gender == 'male')
                                                            value="male">Male</option>
                                                        <option @selected($lecturer->gender == 'female')
                                                ...
                                                <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <input type="file" class="form-control form-control-solid"
                                                        placeholder="" name="pro_pic" value="{{ old('pro_pic')  ?? $lecturer->pro_pic  }}" />
                                                    @error('pro_pic')
                                                        <p class="text-danger">
                                                            {{ $message }}
                                                        </p>
